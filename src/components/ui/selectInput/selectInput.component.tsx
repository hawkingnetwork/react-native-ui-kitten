...
import { ButtonProps, Button } from "../button/button.component";
import {
  allWithRest,
  isValidString,
  WebEventResponder,
...
export interface SelectInputProps extends StyledComponentProps, ButtonProps {
  status?: string;
  size?: string;
  disabled?: boolean;
  label?: string;
...
export type SelectInputElement = React.ReactElement<SelectInputProps>;
 ...
 */
export class SelectInputComponent extends React.Component<SelectInputProps>
  implements WebEventResponderCallbacks {
  static styledComponentName: string = "SelectInput";
    ...
    return (
      <View style={[componentStyle.container, styles.container]}>
        ...
        <View style={[styles.inputAndEnhancerContainer]}>
          ...
          <Component
            style={[
              // { borderColor: componentStyle.inputContainer.borderColor },
...
export const SelectInput = styled<SelectInputProps>(SelectInputComponent);
